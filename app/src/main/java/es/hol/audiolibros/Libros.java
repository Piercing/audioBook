...
public class Libros {
   ...
   Libros( int _Id, String _Titulo, String _Autor, String _Tema,
           String _Descrip, String _Mp3url, int _Posicion, byte[] _Imagen ) {
   ...
   Libros( String _Titulo, String _Autor, String _Tema,
           String _Descrip, String _Mp3url, int _Posicion, byte[] _Imagen ) {
